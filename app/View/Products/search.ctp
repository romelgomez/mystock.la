        ...
        <div class="col-xs-12">
            ...
            <div class="row" id="no-products" style="display: none;">
                <div class="col-xs-12">
                    <div  class="alert alert-info" role="alert" >
                        Aparentemente no hay productos publicados aun que coincidan con su búsqueda.
                    </div>
                </div>
            </div>
            <div class="row" id="yes-products" style="display: none;">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h1 id="type" class="page-header" style="margin-top: 0;">Search <small id="search-info"></small></h1>
                        </div>
                    </div>
