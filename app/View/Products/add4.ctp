...
<div class="container-fluid">
    <div class="row">
        ...
        <form role="form" action="/newProduct" id="ProductAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <input type="hidden" name="data[Product][category_id]" id="ProductCategoryId">
            ...
            <form action="/newProduct" id="ProductAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                <input type="hidden" name="data[Product][category_id]" id="ProductCategoryId">
            ...
            <!-- inter -->
            <div id="add-product" style="overflow: hidden; ">
                    ...
                    <tbody>
                        <tr>
                            <td style="width:137px">
                                <button id="edit-category" type="button" class="btn btn-inverse" style="padding-top: 6px;padding-bottom: 6px;"  >Editar Categoría</button>
                            </td>
                            <td>
                ...
                <div class="form-group">
                    <label class="control-label" for="ProductBody"><i class="icon-align-justify"></i> Descripción</label>
                    <div class="controls">
                    ...
                    if(isset($url_action)){
                        ...
                        if($url_action == 'editar' || $url_action == 'editar_borrador'){
                            ...
                            <?php
                                ...
                                <div style="overflow: hidden; padding-bottom: 7px;" class="required" ><span><i class="icon-picture"></i> Imágenes:</span> <a id="continue-upload" style="display:none" href="#"  >añadir mas</a> </div>
                                <div style="padding: 7px; border: 1px solid #CCC; background-color: white; cursor: pointer;  overflow: hidden;  -moz-border-radius: 2px; border-radius: 2px;">
...
<div class="modal hide fade container"   id="uploading-pictures"  >
    <form id="UserAddForm" action="#" method="post" accept-charset="utf-8">
        ...
        <div class="modal-header">
            ...
            <h3>Carga imágenes del producto o servicio</h3>
        </div>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            <center>
                                ...
                                <div><button type="submit" class="btn btn-primary" style="position: relative; overflow: hidden; direction: ltr; ">Seleciona las imágenes desde la computadora<input id="first-files" multiple="multiple" type="file" name="file" style="position: absolute; right: 0px; top: 0px; font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0; "></button></div>
                            </center>
                        </div>
                        <div class="span4"></div>
                    </div>
