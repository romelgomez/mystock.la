            ...
            if(segments != ""){
                ...
                if(split_segments.length){
                    $(split_segments).each(function(index,parameter){
                        ...
                        if(parameter.indexOf("category-") !== -1){

                            var categoryNameAndId = utility.stringReplace(parameter,'category-','');
        ...
        var search = function(){
            ...
            var new_search_validate_obj = {
                "submitHandler": function(){
                    ...
                    $("#search-info").text(utility.capitaliseFirstLetter(request_this.search));
